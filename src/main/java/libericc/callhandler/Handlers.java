...
import libericc.callhandler.CallHandler.MethodSig;
import libericc.callhandler.bundle.*;
import libericc.callhandler.intent.*;
import libericc.callhandler.lifecycle.*;
import soot.Scene;
...
/*
 * the collector of handlers
 * IDE analyzer queries it
 */
